...
class Model:
    def __init__(self,x_dimension=20,h_dimension=30,n_classes=10,batch_size=32,n_epoch=50,path_length=10,
    ...
    def build(self):
        ...
        l_range_dense2 = lasagne.layers.DenseLayer(l_range_flatten,self.h_dim,W=D2,nonlinearity=lasagne.nonlinearities.sigmoid) #[bs*path_length,dimension]
        ...
        l_range_hidden=lasagne.layers.ReshapeLayer(l_range_dense2,[self.batch_size*self.path_length,1,self.h_dim])
        if test_mode:
...
if __name__=='__main__':
    ...
    if test_mode:
        ...
        parser.add_argument('--x_dimension', type=int, default=20, help='Dimension#')
