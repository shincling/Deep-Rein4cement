...
class Model:
    ...
    def build(self):
        ...
        l_range_conv1=lasagne.layers.Conv2DLayer(l_range_conv1,num_filters=64,filter_size=(3,3),nonlinearity=lasagne.nonlinearities.rectify)
        l_pool1=lasagne.layers.MaxPool2DLayer(l_range_conv1,pool_size=(2,2))
        # l_pool1=lasagne.layers.DropoutLayer(l_pool1,p=0.2)
        ...
        # l_pool2=lasagne.layers.DropoutLayer(l_pool2,p=0.2)
