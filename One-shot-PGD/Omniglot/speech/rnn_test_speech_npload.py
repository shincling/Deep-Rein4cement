...
def lasagne_model():
    ...
    l_rnn1_right=lasagne.layers.LSTMLayer(l_in,h_dimension)
    l_rnn1_left=lasagne.layers.LSTMLayer(l_in,h_dimension,backwards=True)
    l_rnn1=lasagne.layers.ElemwiseSumLayer((l_rnn1_left,l_rnn1_right))

    l_rnn2_right=lasagne.layers.LSTMLayer(l_rnn1,h_dimension)
    l_rnn2_left=lasagne.layers.LSTMLayer(l_rnn1,h_dimension,backwards=True)
    l_rnn2=lasagne.layers.ElemwiseSumLayer((l_rnn2_left,l_rnn2_right))

    l_hidden3 = DenseLayer(l_rnn2, num_units = h_dimension, nonlinearity=tanh)
    ...
    l_hidden4 = batch_norm(l_hidden4)
